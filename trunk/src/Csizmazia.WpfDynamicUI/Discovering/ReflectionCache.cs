...
// ReSharper restore CheckNamespace
{
    public static class ReflectionCache
    {
        ...
        /// <summary>
        /// returns true if property control should be readonly
        /// </summary>
        /// <param name="propertyInfo"></param>
        /// <returns></returns>
        public static bool IsControlReadonly(this PropertyInfo propertyInfo)
        {
            var editableAttribute = propertyInfo.GetAttribute<EditableAttribute>();
            var hasSetter = propertyInfo.GetSetMethod(false) != null;

            var isEditable = (editableAttribute == null && hasSetter) || (editableAttribute != null && editableAttribute.AllowEdit && hasSetter);
        ...
        /// <summary>
        /// returns true if property control should be enabled
        /// </summary>
        /// <param name="propertyInfo"></param>
        /// <returns></returns>
        public static bool IsControlEnabled(this PropertyInfo propertyInfo)
        {
            var editableAttribute = propertyInfo.GetAttribute<EditableAttribute>();
            var hasSetter = propertyInfo.GetSetMethod(false) != null;
