...
#if BETA
        [Obsolete("Use CurrentModel property instead. This property will be removed when doing final release.", false)]
...
#if BETA
        [Obsolete("Use CanCloseCurrentModel property instead. This property will be removed when doing final release.", false)]
...
#if BETA
        [Obsolete("Use OpenModel method instead. This  will be removed when doing final release.", false)]
...
#if BETA
        [Obsolete("Use CloseCurrentModel method instead. This  will be removed when doing final release.", false)]
...
#if BETA
        [Obsolete("Use CloseCurrentModelAndNavigateTo method instead. This  will be removed when doing final release.", false)]
